...
namespace PopupLogin\TaskModule\Controller\Ajax;
...
class Register extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \PopupLogin\TaskModule\Model\Customer $customerModel
     */
    ...
    public function __construct(
        ...
        \PopupLogin\TaskModule\Model\Customer $customerModel,
        ...
        if ($this->customerModel->userExists($this->getRequest()->getPost('email'))) {
            ...
            try {
                ...
                if (!$isUserRegistered) {
                    $response = [
                        'errors' => true,
                        'message' => __('their is some error')
                    ];
                } else {
