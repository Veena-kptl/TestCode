...
namespace EAVModule\CustomModule\Model\ResourceModel\Eav;
use Magento\Eav\Model\Entity\Attribute as EavAttribute;
use Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface;
use EAVModule\CustomModule\Setup\HelloWorldSetup;
/**
 * Class Attribute
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'Eav_HelloWorld';
    ...
    {
        $this->_init(\RH\HelloWorld\Model\ResourceModel\Attribute::class);
    }
    /**
