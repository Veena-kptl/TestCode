...
namespace EAVModule\CustomModule\Model\ResourceModel\HelloWorld\Grid;
...
use EAVModule\CustomModule\Model\ResourceModel\HelloWorld\Collection as HelloWorldCollection;
/**
 * Class Collection
...
class Collection extends HelloWorldCollection implements SearchResultInterface
{
    ...
    public function __construct(
        ...
        $eventObject,
        $resourceModel,
        $model = 'EAVModule\CustomModule\Ui\Component\Listing\DataProvider\Document',
