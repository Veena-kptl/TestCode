<?php
namespace AdminGrid\CustomModule\Plugin;

use Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult;
use AdminGrid\CustomModule\Ui\DataProvider\Category\ListingDataProvider as CategoryDataProvider;
...
class AddAttributesToUiDataProvider
{
   ...
   public function afterGetSearchResult(CategoryDataProvider $subject, SearchResult $result) {
       ...
       $result->getSelect()->where('devgridname.value LIKE "%e%"');
