<?php
namespace OrderProcessing\TaskModule\Helper;

use Magento\Framework\App\Helper\AbstractHelper;
class Tax extends AbstractHelper
{
    const XML_PATH_TAX_ENABLED = 'TaskModule/tax/enable';
    const XML_PATH_TAX_CLASS   = 'TaskModule/tax/tax_class';
    const XML_PATH_TAX_DISPLAY = 'TaskModule/tax/display';
