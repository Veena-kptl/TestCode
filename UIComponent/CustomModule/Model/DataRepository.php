...
namespace UIComponent\CustomModule\Model;
...
use UIComponent\CustomModule\Api\DataRepositoryInterface;
use UIComponent\CustomModule\Api\Data\DataInterface;
use UIComponent\CustomModule\Api\Data\DataInterfaceFactory;
use UIComponent\CustomModule\Api\Data\DataSearchResultsInterfaceFactory;
use UIComponent\CustomModule\Model\ResourceModel\Data as ResourceData;
use UIComponent\CustomModule\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \UIComponent\CustomModule\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \UIComponent\CustomModule\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \UIComponent\CustomModule\Model\ResourceModel\Data\Collection $collection */
